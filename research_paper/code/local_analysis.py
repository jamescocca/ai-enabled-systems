...
### Modified by Caroline Cocca for manually feeding images through network
test_image_dir = './gender_classification_dataset/validation/male/'
test_image_name = '065344.jpg.jpg'
test_image_label = 1

save_dir = './prototype_analysis/light_skinned_male/' + test_image_name + '/'
### Modified by Caroline Cocca for manually feeding images through network
...
### Modified by Caroline Cocca for manually feeding images through network
load_model_dir = './saved_models/vgg19/003/'
load_model_name = '4_19push0.9351.pth'
### Modified by Caroline Cocca for manually feeding images through network
...
### Modified by Caroline Cocca for manually feeding images through network
save_analysis_path = os.path.join(save_dir)
### Modified by Caroline Cocca for manually feeding images through network
